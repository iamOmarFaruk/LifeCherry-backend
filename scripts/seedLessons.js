...
const lessons = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1504196606672-aef5c9cefc92?w=1200&auto=format&fit=crop',
    visibility: 'public',
    accessLevel: 'free',
    isFeatured: true,
    isReviewed: true,
  ...
  },
  {
    ...
    description:
      'I thought doing everything myself was efficient. Delegating with clear scopes freed hours and let others grow while quality improved.',
    category: 'Career',
    emotionalTone: 'Realization',
    image: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  {
    title: 'Minimalism Cut My Stress',
    description:
      'Donating half my stuff reduced decision fatigue and gave me calm rooms. Owning less turned into feeling lighter.',
    category: 'Mindset',
    emotionalTone: 'Gratitude',
  ...
  {
    title: 'Saying Sorry Saved A Friendship',
    description:
      'A sincere apology with no excuses rebuilt trust faster than months of distance. Humility became my conflict shortcut.',
    category: 'Relationships',
    emotionalTone: 'Realization',
    image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  {
    title: 'Walking Meetings Changed Work',
    description:
      'Switching one-on-ones to walks dissolved tension and sparked better ideas. Movement made conversations honest and focused.',
    category: 'Career',
    emotionalTone: 'Motivational',
  ...
  {
    title: 'From Perfectionism To Progress',
    description:
      'Shipping messy drafts weekly beat polishing one masterpiece yearly. Small releases taught me faster than endless edits.',
    category: 'Personal Growth',
    emotionalTone: 'Motivational',
    image: 'https://images.unsplash.com/photo-1483478550801-ceba5fe50e8e?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  {
    title: 'Micro-Journaling For Clarity',
    description:
      'Three bullet points each night—what worked, what hurt, what to try—became a feedback loop that improved my weeks.',
    category: 'Mindset',
    emotionalTone: 'Gratitude',
    image: 'https://images.unsplash.com/photo-1483794344563-d27a8d18014e?w=1200&auto=format&fit=crop',
    visibility: 'public',
    accessLevel: 'free',
    isFeatured: true,
    isReviewed: true,
  ...
  {
    title: 'Turning Anxiety Into Action',
    description:
      'Naming my worst-case, planning mitigation, and setting a 10-minute action replaced spirals with momentum.',
    category: 'Mindset',
    emotionalTone: 'Realization',
    image: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  },
  {
    ...
    description:
      'Scheduling calls and saying no to surprise visits felt harsh at first. It made time together warmer and respectful.',
    category: 'Relationships',
    emotionalTone: 'Realization',
    image: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  {
    title: 'Community Over Networking',
    description:
      'Showing up weekly to help at a meetup led to real friendships and opportunities—far better than swapping business cards.',
    category: 'Career',
    emotionalTone: 'Gratitude',
    image: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  {
    title: 'Cooking Became Therapy',
    description:
      'Chopping vegetables after work calmed my nervous system better than doomscrolling. A simple meal became a ritual.',
    category: 'Personal Growth',
    emotionalTone: 'Gratitude',
  ...
  },
  {
    ...
    description:
      'Ten minutes of sunrise light fixed my sleep and focus more than any productivity hack I tried.',
    category: 'Mindset',
    emotionalTone: 'Motivational',
    image: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  {
    title: 'Stretching Away Pain',
    description:
      'A five-minute mobility routine erased my chronic back ache. Movement snacks now live between all my meetings.',
    category: 'Mindset',
    emotionalTone: 'Motivational',
    image: 'https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  {
    title: 'Job Rejection To Redirection',
    description:
      'A rejection email pushed me to freelance for 90 days. It unlocked a niche I now love and own.',
    category: 'Career',
    emotionalTone: 'Realization',
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  {
    title: 'Digital Sabbath Reset',
    description:
      'One screen-free day a week restored my attention span. Boredom returned creativity I missed.',
    category: 'Mindset',
    emotionalTone: 'Gratitude',
    image: 'https://images.unsplash.com/photo-1493836512294-502baa1986e2?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  },
  {
    ...
    description:
      'Ten pages before bed became forty books a year. Low friction and no goals kept it enjoyable.',
    category: 'Personal Growth',
    emotionalTone: 'Motivational',
    image: 'https://images.unsplash.com/photo-1457694587812-e8bf29a43845?w=1200&auto=format&fit=crop',
    visibility: 'public',
    accessLevel: 'free',
    isFeatured: false,
    isReviewed: true,
  ...
  {
    title: 'Documenting Wins',
    description:
      'Keeping a weekly win list made performance reviews easy and boosted my confidence on bad days.',
    category: 'Career',
    emotionalTone: 'Gratitude',
  ...
  {
    title: 'Financial Reset In 90 Days',
    description:
      'Tracking every expense for three months revealed leaks. Automating bills and sinking funds ended my money anxiety.',
    category: 'Mistakes Learned',
    emotionalTone: 'Realization',
    image: 'https://images.unsplash.com/photo-1554224154-22dec7ec8818?w=1200&auto=format&fit=crop',
    visibility: 'public',
    accessLevel: 'premium',
    isFeatured: false,
    isReviewed: true,
  ...
  {
    title: 'Mentor Mondays',
    description:
      'Blocking one hour weekly to ask mentors three questions multiplied my learning far beyond courses.',
    category: 'Career',
    emotionalTone: 'Motivational',
    image: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  {
    title: 'Side Project To Startup',
    description:
      'A weekend experiment turned into revenue after six months of consistent Sundays. Slow and steady won.',
    category: 'Career',
    emotionalTone: 'Motivational',
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200&auto=format&fit=crop',
    visibility: 'public',
  ...
  {
    title: 'Listening Walks With Kids',
    description:
      'Evening walks where my kids pick the topic became our safest space. Eye-level listening built trust fast.',
    category: 'Relationships',
    emotionalTone: 'Gratitude',
    image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=1200&auto=format&fit=crop',
    visibility: 'public',
